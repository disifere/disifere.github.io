...
Traditional approaches involve structured lifestyle programs, such as group or individual educational sessions, behavioural change strategies, self-monitoring, the distribution of written materials and telephone counselling. Research has demonstrated that such interventions can effectively boost physical activity and reduce sedentary behaviour, though evidence tends to support only short-term effectiveness. The long-term impact remains insufficiently studied and these programs are often demanding in terms of labour and resources.
...
Secondary are those who more broadly benefit from the deepened topic understanding, and will occasionally look for the latest research in their topic of interest.
- Prosumers
...
The consumer group, while not the direct target, is the target audience of those primary & secondary groups. Typically the consumer group does not follow the latest research and relies on the primary and secondary to distil & repack the information in a way that is more easily accessible.
...
In the words of the authors, this study was about understanding and measuring "... the effects of interventions utilizing consumer-based wearable activity trackers on physical activity participation and sedentary behaviour when compared with interventions that do not utilize activity tracker feedback."
...
- Clear & structured study selection procedures.
...
- Visual(Flowchart) & text breakdown of study selection procedure in action
- Summary of findings
...
A case for relevance- the study addresses a major global health issue of increasing importance. It evaluates a technology who's accessibility and adoption is ever increasing as well a providing a valuable data that can be fed into public health strategies, research, health intervention/monitoring, & even clinical recommendation. 
